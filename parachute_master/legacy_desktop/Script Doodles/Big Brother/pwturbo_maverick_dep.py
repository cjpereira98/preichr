...
# sites
#SITES = [["LGB8", "ONT8", "LAS1", "LAX9"], ["VGT2", "MCC1", "SBD1", "SCK4"], ["GYR2", "GYR3", "SMF3"]]# "ABE8", "AVP1", "FTW1", "CLT2", "ONT8", "LGB8", "MDW2"}
#SITES = {"TEB9"}
SITES = [["GYR2", "GYR3"]]
...
def pull_actuals(site, sites_dict, driver):
    ...
    for process_name, process_id in processes.items():
        ...
        for attempt in range(3):
            ...
            filename = f"functionRollupReport-{site}-{process_name}-Week-20251102070000-20251109070000.csv"
...
def output_to_csv(sites_dict):
    ...
    output_file = "weekly_staffing_results_turbo_mav3.csv"
