...
OUTPUT_CSV = "ytd_presort.csv"
PROCESS_ID = 1003008  # RC Presort
...
def parse_presort_cartons(csv_path: str) -> int | float | None:
    """
    Parse presort cartons by summing 'Jobs' for rows where 'Unit Type' == 'Case'.
    """
    import pandas as pd
    ...
    try:
        ...
        for site in site_list:
            for wk in ytd_weeks:
                ...
                try:
                    val = parse_presort_cartons(csv_file)
                except Exception as e:
