...
class FluidLoadCase(Metric):
    ...
    def aggregate_shift(self, shift: str):
        ...
        previous_sunday = most_recent_sunday - timedelta(days=7) # Move back one full week to previous Sunday ADDING IN A TEMPORARY LOOKBACK OF 7 DAYS
    ...
    def fetch_and_sum_data(self, start: datetime, end: datetime):
        ...
        # Generate URL
        url = f"https://fclm-portal.amazon.com/reports/unitsRollup?reportFormat=CSV&warehouseId=SWF2&jobAction=FluidLoadCase&startDate={start_date}&startHour={start_hour}&startMinute=0&endDate={end_date}&endHour={end_hour}&endMinute=0"
        ...
        download_filename = f"unitsRollup-SWF2-FluidLoadCase-{start_str_utc}-{end_str_utc}.csv"
...
def main():
    ...
    for specificity in specificities:
        ...
        result = fluid_load_case.get(specificity=specificity, start=start, end=end)
