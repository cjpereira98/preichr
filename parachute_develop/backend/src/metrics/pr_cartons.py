...
class PRCartons(Metric):
    ...
    def fetch_and_sum_data(self, start: datetime, end: datetime):
        ...
        # Generate URL
        url = f"https://fclm-portal.amazon.com/reports/unitsRollup?reportFormat=CSV&warehouseId=SWF2&jobAction=PalletReceived&startDate={start_date}&startHour={start_hour}&startMinute=0&endDate={end_date}&endHour={end_hour}&endMinute=0"
        ...
        download_filename = f"unitsRollup-SWF2-PalletReceived-{start_str_utc}-{end_str_utc}.csv"
